 ...
 * {@link com.downloadmanager.activity.ADownloadManager}.
 * </p>
 *
 * @author shibaprasad
 * @version 1.2
...
public class CompleteListAdapter extends BaseAdapter {
     ...
     * Public constructor.
     *
     * @param context          the com.downloadmanager.activity context.
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            holder.fileName = (TitleTextView) view.findViewById(R.id.title);
