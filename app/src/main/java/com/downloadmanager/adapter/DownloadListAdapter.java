...
public class DownloadListAdapter extends BaseAdapter implements Serializable {
    ...
    /**
     * Get the {@link com.downloadmanager.object_holder.DownloadData} List.
     *
     * @return the global reference of global {@link com.downloadmanager.object_holder.DownloadData}
     */
    ...
    /**
     * get a {@link com.downloadmanager.object_holder.DownloadData} from the list by a index position.
     *
    ...
    /**
     * Get the reference of the list view who is currently using the com.downloadmanager.adapter.
     *
     * @return the listview.
     */
    ...
    /**
     * Set the list view who using the com.downloadmanager.adapter.
     *
     * @param listView the list com.downloadmanager.adapter.
     */
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        TitleTextView fName = (TitleTextView) view.findViewById(R.id.file_name);
        LabelTextView fDownload = (LabelTextView) view.findViewById(R.id.totalSize);
        LabelTextView fPercent = (LabelTextView) view.findViewById(R.id.percentage);
        LabelTextView fTraffic = (LabelTextView) view.findViewById(R.id.traffic_size);
