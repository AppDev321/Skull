package com.downloadmanager.system_core;

@SuppressWarnings("UnusedDeclaration")
public class SystemIntent {
    public static final String INTENT_ACTION_START_SERVICE = "in.cyberspj.video_downloader.com.downloadmanager.download_manager.services.IDownloadService";
