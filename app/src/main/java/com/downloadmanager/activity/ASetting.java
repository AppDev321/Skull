...
import com.downloadmanager.dialogs.OnClickButtonListener;
...
/**
 * ASetting Activity is responsible for all setting toggle task of the com.downloadmanager.application.
...
public class ASetting extends ABase {
    ...
    /**
     * System call back method when the com.downloadmanager.activity first opened.
     *
