...
import com.downloadmanager.adapter.CompleteListAdapter;
import com.downloadmanager.adapter.DownloadListAdapter;
import com.downloadmanager.application.App;
import com.downloadmanager.dialogs.MessageDialog;
import com.downloadmanager.dialogs.YesNoDialog;
import com.downloadmanager.download_manager.services.DownloadController;
...
import com.downloadmanager.tools.FileCatalog;
import com.downloadmanager.tools.NetworkUtils;
...
public class ADownloadManager extends ABase {
    ...
    private TitleTextView title, runningToggle, completedToggle;
    private ImageButton backButton, menuButton;
    //list com.downloadmanager.adapter.
    ...
    private void initViews() {
        title = (TitleTextView) findViewById(R.id.title); //com.downloadmanager.activity title.
        runningToggle = (TitleTextView) findViewById(R.id.download); //running toggle button.
        completedToggle = (TitleTextView) findViewById(R.id.downloaded); //completed toggle button.
    ...
    /**
     * Check the com.downloadmanager.activity intent.
     */
     ...
     * 1. {@link com.downloadmanager.adapter.DownloadListAdapter}
     * 2. {@link com.downloadmanager.adapter.CompleteListAdapter}
     */
    ...
    /**
     * System calls this method when the com.downloadmanager.activity first open.
     *
    ...
    public void onCreate(Bundle bundle) {
        ...
        //set the context and com.downloadmanager.application reference object.
        ...
        //Go for a download movies or any file
        Bundle b = getIntent().getExtras();
        if (b != null) {
            downloadMovie(b.getString(Constants.KEY_DOWNLOAD_URL),b.getString(Constants.KEY_DOWNLOAD_TITLE));
        }
    ...
    /**
     * Set the {@link com.downloadmanager.adapter.DownloadListAdapter} to the listview. and set the listview reference to
     * the com.downloadmanager.adapter.
     */
    private void setDownloadingListAdapter() {
        listView.setAdapter(application.getDataHandler().getDownloadingListAdapter());
        //set the list reference object to the com.downloadmanager.adapter class.
        application.getDataHandler().getDownloadingListAdapter().setListView(listView);
        //change the com.downloadmanager.activity's selected status.
        SELECTED_STATUS = RUN_SELECTED;

        //exchange the background selector drawable of the text views.
        completedToggle.setTextColor(getResources().getColor(R.color.color_tab_bars));
        runningToggle.setTextColor(getResources().getColor(R.color.white));
    }

    /**
     * Set the {@link com.downloadmanager.adapter.CompleteListAdapter} to the ListView.
     */
    private void setCompleteListAdapter() {
        ...
        //exchange the background selector drawable of the text views.
        completedToggle.setTextColor(getResources().getColor(R.color.white));
        runningToggle.setTextColor(getResources().getColor(R.color.color_tab_bars));

    }

    /**
     * Create the on-click function of the drop down menu of the right-top side of the com.downloadmanager.activity screen
                    ...
                    private void initDialog() {
                        ...
                        buffer_max.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                dialog.dismiss();
                                String message = "To set " + getString(R.string.app_name) + " downloader for its full speed download capability " +
    ...
    public void downloadMovie(String url, String JFileName) {

        final String JFilePath = FileCatalog.calculateCatalog(JFileName, "/storage/emulated/0/");
        ...
        if (JError == null) {
            try {
                ...
                intent.putExtra(SystemIntent.FILE_URL, file_url);
                intent.putExtra(SystemIntent.FILE_NAME, JFileName);
                intent.putExtra(SystemIntent.FILE_PATH, JFilePath);
                intent.putExtra(SystemIntent.WEB_PAGE, file_url);
            ...
            Toast.makeText(context, JError, Toast.LENGTH_LONG).show();
        }
