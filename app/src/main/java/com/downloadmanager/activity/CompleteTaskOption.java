...
import static com.downloadmanager.activity.ABase.DEFAULT_SIZE;
import static com.downloadmanager.activity.ABase.INPUT_SIZE;
...
public class CompleteTaskOption implements View.OnClickListener {
     ...
     * @param completeListAdapter complete list com.downloadmanager.adapter.
     */
    ...
    public void open(String path, String name) {
        ...
        try {
            ...
            String message = "Unrecognized file format. Try to " +
                    "open the file from another file manager com.downloadmanager.application.";
        ...
        propertyDialog.findViewById(R.id.web_page_title).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               /* Intent intent = new Intent(context, AWeb.class);
                ...
                //Add here download serviec android
