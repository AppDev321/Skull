package com.downloadmanager.download_manager;
...
public class FileWriter extends RandomAccessFile {
    ...
    /**
     * The call back interface that is used to notify the costumer of the {@link com.downloadmanager.download_manager.FileWriter}
    ...
    public static interface onWriteFinish {
         ...
         * of the {@link com.downloadmanager.download_manager.FileWriter} class, so that they can do some thing if they
         * wanted to do.
         */
