...
import static com.downloadmanager.tools.NetworkUtils.isNetworkAvailable;
...
public class DownloadTask extends AsyncTask<Void, Integer, Long> {
    ...
    //com.downloadmanager.application context.
     ...
     *
     * @param application  com.downloadmanager.application
    ...
    private long downloadEngine(RandomFileAccess randomFileAccess, InputStream inputStream) throws Exception {
        ...
        if (!URLUtil.isValidUrl(fileUrl))
            throw new Exception("YoutubePareUrl is not valid.");
